...
describe('getInputs', () => {
  ...
  test('uses Build git context when source input is empty', async () => {
    const gitContext = 'https://github.com/step-security/docker-bake-action.git?ref=refs/heads/master&checksum=0123456789abcdef';
  ...
  test('renders defaultContext source templates from Build git context', async () => {
    const gitContext = 'https://github.com/step-security/docker-bake-action.git#refs/heads/master';
    const gitContextSpy = vi.spyOn(Build.prototype, 'gitContext').mockResolvedValue(gitContext);
    setRequiredBooleanInputs();
  ...
  test.each([
    ...
    [
      ...
      [
        'bake',
        '--metadata-file', metadataJson,
        '--set', `lint.attest=type=provenance,mode=min,inline-only=true,builder-id=https://github.com/step-security/docker-bake-action/actions/runs/123456789/attempts/1`,
        '--set', `validate-docs.attest=type=provenance,mode=min,inline-only=true,builder-id=https://github.com/step-security/docker-bake-action/actions/runs/123456789/attempts/1`,
        '--set', `validate-vendor.attest=type=provenance,mode=min,inline-only=true,builder-id=https://github.com/step-security/docker-bake-action/actions/runs/123456789/attempts/1`,
      ],
      undefined
    ],
    [
      ...
      [
        'bake',
        '--metadata-file', metadataJson,
        "--provenance", `builder-id=https://github.com/step-security/docker-bake-action/actions/runs/123456789/attempts/1`
      ],
      undefined
    ],
    [
      ...
      [
        'bake',
        '--metadata-file', metadataJson,
        "--provenance", `mode=max,builder-id=https://github.com/step-security/docker-bake-action/actions/runs/123456789/attempts/1`
      ],
      undefined
    ],
    [
    ...
    [
      ...
      [
        'bake',
        'https://github.com/step-security/docker-bake-action.git#refs/heads/master',
        '--file', './foo.hcl',
        '--metadata-file', metadataJson,
        '--set', `lint.attest=type=provenance,mode=min,inline-only=true,builder-id=https://github.com/step-security/docker-bake-action/actions/runs/123456789/attempts/1`,
        '--set', `validate-docs.attest=type=provenance,mode=min,inline-only=true,builder-id=https://github.com/step-security/docker-bake-action/actions/runs/123456789/attempts/1`,
    ...
    [
      ...
      [
        'bake',
        'https://github.com/step-security/docker-bake-action.git#refs/heads/master:subdir',
        '--file', './foo.hcl',
        '--metadata-file', metadataJson,
        '--set', `lint.attest=type=provenance,mode=min,inline-only=true,builder-id=https://github.com/step-security/docker-bake-action/actions/runs/123456789/attempts/1`,
        '--set', `validate-docs.attest=type=provenance,mode=min,inline-only=true,builder-id=https://github.com/step-security/docker-bake-action/actions/runs/123456789/attempts/1`,
    ...
    [
      ...
      [
        'bake',
        'https://github.com/step-security/docker-bake-action.git?ref=refs/heads/master',
        '--allow', 'fs=*',
        '--file', './foo.hcl',
        '--metadata-file', metadataJson,
        '--set', `lint.attest=type=provenance,mode=min,inline-only=true,builder-id=https://github.com/step-security/docker-bake-action/actions/runs/123456789/attempts/1`,
